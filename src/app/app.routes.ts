...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'catalogos/estatus-inspeccion-det', data: { catalogKey: 'estatus-inspeccion-det' }, loadComponent: () => import('@features/estatus-inspeccion-det/pages/estatus-inspeccion-det-list/estatus-inspeccion-det-list.component').then((module) => module.EstatusInspeccionDetListComponent) },
