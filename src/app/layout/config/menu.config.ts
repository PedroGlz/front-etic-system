  ...
  },
  {
    ...
    items: [
      ...
      { key: 'categorias-equipos', label: 'Categorías de equipos', icon: 'pi-tags' },
      {
        ...
        adminOnly: true,
        children: [
          { key: 'clientes', label: 'Clientes', icon: 'pi-briefcase' },
          { key: 'grupos-sitios', label: 'Grupos de sitios', icon: 'pi-objects-column' },
          { key: 'sitios', label: 'Sitios', icon: 'pi-map-marker' },
        ],
      },
      ...
      { key: 'estatus-inspeccion-det', label: 'Estatus Inspección ubicaciones', icon: 'pi-list-check', adminOnly: true },
